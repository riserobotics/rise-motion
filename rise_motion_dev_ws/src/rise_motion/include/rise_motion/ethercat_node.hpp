...
private:
  ...
  rclcpp::Subscription<rise_motion_messages::msg::MotorTorqueOffset>::SharedPtr torque_cmd_sub_;
  ...
  void torqueCommandCallback(rise_motion_messages::msg::MotorTorqueOffset::SharedPtr msg);
